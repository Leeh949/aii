...
매개변수가 1개: length가 매개변수만큼의 크기인 배열을 return
매개변수2개이상: 매개변수로 배열을 생성해서 return 
*/ 

function array(){ // argments(매개변수 배열): 매개변수의 내용
  let result = [];
  if(arguments.length==1){
    //result를 arguments[0] 만큼의 크기인 배열로 : result.push(pull)을 arguments[0]번
